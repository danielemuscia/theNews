      ...
      <View style={{ backgroundColor: "white", flex: 1, marginTop: 80 }}>
        {state.readLater.length > 0 ? (
          ...
          >
            ...
            >
              {!state.dbErr
                ? "Nessun articolo salvato. Torna alla pagina delle notizie e salva gli articoli che vuoi leggere con calma"
                : "Al momento abbiamo un problema con il server. Riprova più tardi"}
            </Text>
          </View>
        )}
      </View>
